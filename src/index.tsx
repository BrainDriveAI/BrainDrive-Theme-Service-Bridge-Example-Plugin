...
import { ThemeDisplay, ThemeController, ThemeListener, SettingsExample } from './components';

// Main entry point for ServiceExample_Theme plugin

// Export individual modules for BrainDrive to load
export { ThemeDisplay, ThemeController, ThemeListener, SettingsExample };

// Export the main theme display component as default
      ...
      root.render(
        <React.StrictMode>
          <div style={{ padding: '20px' }}>
            <h2>ServiceExample_Theme - Development Mode</h2>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', marginTop: '20px' }}>
              <ThemeDisplay services={mockServices} />
              <ThemeController services={mockServices} />
            </div>
            <div style={{ marginTop: '20px' }}>
              <ThemeListener services={mockServices} />
            </div>
          </div>
        </React.StrictMode>
      );
